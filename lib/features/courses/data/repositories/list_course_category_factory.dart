...
ListCourseCategories makeRemoteCourseListCategories({Map<String, dynamic>? query}) => RemoteListCourseCategories(
  httpClient: makeHttpAdapter(),
  url: makeApiUrl('venver/courses/categories', params: query),
);