...
ListCourseSections makeRemoteListCourseSections(String courseId, {Map<String, dynamic>? query}) => RemoteListCourseSections(
  httpClient: makeHttpAdapter(),
  url: makeApiUrl('venver/courses/$courseId/sections', params: query),
);
