...
class RemoteGetBehaviorAverageMonthlyReport implements GetBehaviorAverageMonthlyReport {
  RemoteGetBehaviorAverageMonthlyReport({required this.httpClient, required this.url});
